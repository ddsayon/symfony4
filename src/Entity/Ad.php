...
class Ad
{
    ...
    * @ORM\Id()
     ...
     *      min = 2,
     *      max = 50,
     *      minMessage = "Le titre doit pas faire moins de {{ limit }}caractères",
     ...
     */  
             /*on peut aussi préciser l'extention du ficher, seulement les placeholder ne marcheront pas:  *@Assert\Regex(
           *pattern="#\.(jpg|png|gif)$#",
           *match=true,
